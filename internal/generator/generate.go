...
var EverforestStyleConfig = ansi.StyleConfig{
	Document: ansi.StyleBlock{
		StylePrimitive: ansi.StylePrimitive{
			BlockPrefix: "\n",
			BlockSuffix: "\n",
...
var DefaultStyles = map[string]*ansi.StyleConfig{
	...
	"everforest": &EverforestStyleConfig,
}

func Generate() {
	for style, styleConfig := range DefaultStyles {
